...
struct CullInstancePass
{
    ...
    {
        return MAX_NOOF_INSTANCES;
        // uint32_t res = (instance_count / 2 / NOOF_THREADS_SCAN_INSTANCES + 1) * NOOF_THREADS_SCAN_INSTANCES * 2;
    ...
    void record_dispatch( const RecordDispatchParams& in_params, ResourceStateTracker& in_state_tracker )
    {
        ...
        auto fill_cb = [in_num_inst, in_num_meshes, in_vp_no_transpose](CB& cb){
            cb = {};
        ...
        auto dispatch_kill_instance_pass = [in_cmd_list, this, in_num_inst, in_num_meshes, in_vp_no_transpose](
            ...
            auto out_command_buffer )
            {
                ...
                int num_groups = 1 + in_num_inst / NOOF_THREADS_KILL_INSTANCES;
        ...
        auto dispatch_scan_prefix = [in_cmd_list, this, in_num_inst](
            ...
            auto out_group_sum_buffer )
            {
                ...
                unsigned groupX = get_padded_size( in_num_inst ) / 2 / NOOF_THREADS_SCAN_INSTANCES;
        ...
        auto dispatch_scan_group = [in_cmd_list, this, in_num_inst](
            auto out_group_sum_buffer )
            {
                ...
                in_cmd_list->SetComputeRoot32BitConstants( 0, sizeof(CB) / sizeof(unsigned int), &m_cb, 0 );
                in_cmd_list->SetComputeRootUnorderedAccessView( 1, out_group_sum_buffer );
        ...
        auto dispatch_copy_instance_pass = [in_cmd_list, this, in_num_inst](
            ...
            auto out_proccessed_inst_buffer )
            {
                ...
                unsigned groupX = (in_num_inst / NOOF_THREADS_COPY_INSTANCES) + 1;
                in_cmd_list->Dispatch( groupX, 1, 1 );
            };
        ...
        auto dispatch_clear_buffer_pass = [in_cmd_list, in_num_inst, this](
            auto inst_buffer,
            ...
            in_cmd_list->SetComputeRootUnorderedAccessView( 1, is_inst_alive_buffer );
            in_cmd_list->SetComputeRootUnorderedAccessView( 2, m_scanned_group_sum_buffer.buffer->GetGPUVirtualAddress() );
            in_cmd_list->SetComputeRootUnorderedAccessView( 3, inst_newpos_buffer );
            in_cmd_list->SetComputeRootUnorderedAccessView( 4, m_group_sum_buffer.buffer->GetGPUVirtualAddress() );
        ...
        auto wg_dispatch_kill_instance_pass = [in_num_inst, in_cmd_list, this, in_num_meshes, in_vp_no_transpose](
            ...
            auto out_command_buffer,
            auto out_group_sum_buffer,
            auto out_scanned_instance_predicates,
            auto out_proccessed_inst_buffer,
            auto out_scanned_group_sum_buffer ){
            ...
            in_cmd_list->SetComputeRootUnorderedAccessView(2, out_is_inst_alive_buffer);
            in_cmd_list->SetComputeRootUnorderedAccessView(3, out_command_buffer);
            in_cmd_list->SetComputeRootUnorderedAccessView(4, out_group_sum_buffer);
            in_cmd_list->SetComputeRootUnorderedAccessView(5, out_scanned_instance_predicates);
            in_cmd_list->SetComputeRootUnorderedAccessView(6, out_proccessed_inst_buffer);
            in_cmd_list->SetComputeRootUnorderedAccessView(7, out_scanned_group_sum_buffer);
